...
const NoItemsCartIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      clipRule="evenodd"
    />
    <rect width={71} height={75} x={89} y={83} fill="currentColor" rx={2} />
    <path
      fill="#F8ECFF"
      fillRule="evenodd"
      d="M93.585 124.006v-34.36c0-1.416 1.16-2.564 2.592-2.564l60.976 64.082c0 1.888-1.511 3.418-3.375 3.418H96.96c-1.864 0-3.375-1.53-3.375-3.418v-27.158m0 7.419v-3.848Z"
      clipRule="evenodd"
    />
    <path
      stroke="#8448A9"
...
export default NoItemsCartIcon;
