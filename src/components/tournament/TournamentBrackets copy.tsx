...
const TournamentBrackets = ({ activeLeague }: IProps) => {
  ...
  const firstLevelHeightContainer = 2 ** 0 * firstLevelHeight + 1 * 2;

  const secondLevelHeightContainer = 2 ** 1 * firstLevelHeight + 1 * 2;

  const thirdLevelHeightContainer = 2 ** 2 * firstLevelHeight + 1 * 2;

  const fourthLevelHeightContainer = 2 ** 3 * firstLevelHeight + 1 * 2;
